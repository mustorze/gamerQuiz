...
public class escolhaCerta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           escolhaDao e = new escolhaDao();
           
           boolean ok = e.definirPrincipal(i, px);
           ...
           if (ok == true) {
                ...
                response.sendRedirect("admin/index.jsp?f=perguntas&p=editar&i="+px+"&c=erro");
